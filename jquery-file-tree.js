        ...
        $.fn.eventPathClick = function () {
            $('.directory > a[href="#"]').off('click').on('click', function (e) {
                ...
                if ($li.has('ul').length == 0) {
                    ...
                    //$('#consolePanel .layer-panel.is-current .div-textarea')[0].value += path + " を選択しました。\n";
            ...
            $('.file > a[href="#"]').off('click').on('click', function (e) {
                //$('#consolePanel .layer-panel.is-current .div-textarea')[0].value += $(e.currentTarget).attr('rel') + " を選択しました。\n";
